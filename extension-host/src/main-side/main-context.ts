...
import { LitheLanguagesMain } from './languages';
...
export function registerMainSide(rpc: RPCProtocol, connection: LitheConnection, storage: StateStore,
    ...
    const languages = new LitheLanguagesMain(context, rpc, documents);
    ...
    return { context, documents, commands, workspace, storage, languages };
}
