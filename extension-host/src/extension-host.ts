...
export class ExtensionHost {
    ...
    constructor(
        ...
        connection.onNotification(Methods.documentChanged, params => this.ready().mainSide.documents.change(params as DocumentChangedParams));
        connection.onNotification(Methods.documentSaved, params => this.ready().mainSide.documents.saved(requireString(params, 'uri')));
        connection.onNotification(Methods.documentClosed, params => this.ready().mainSide.documents.close(requireString(params, 'uri')));
