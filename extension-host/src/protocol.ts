...
export const Methods = {
    ...
    languageProviderRegistered: 'lithe/languageProviderRegistered',
    languageProviderUnregistered: 'lithe/languageProviderUnregistered',
    diagnosticsChanged: 'lithe/diagnosticsChanged',
    diagnosticsCleared: 'lithe/diagnosticsCleared',
} as const;
...
/** Language calls use one-based coordinates and one concrete registration. */
export interface LanguageFeatureParams {
    kind: 'completion' | 'hover' | 'definition' | 'references';
    handle: number;
    uri: string;
    line: number;
    character: number;
...
export interface LanguageDiagnostic {
    ...
    code: string | null;
    tags: number[];
    relatedInformation: { uri: string; range: Range; message: string }[];
}

/** Opaque completion identity returned in a normalized completion item's data. */
