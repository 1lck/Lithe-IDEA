...
struct EditorJavaViewportTests {
    ...
    func mountedPreviewKeepsCommandsAndFindStateLocal(isPreview: Bool) async throws {
        ...
        #expect(textView.onCompletionSelected == nil)
        #expect(textView.onRenameRequested == nil)
        #expect(textView.onFormatRequested == nil)
        #expect(textView.onCodeActionsRequested == nil)
