...
/// Owns the Agent connection and conversations of one project, and batches
/// streaming text before UI updates.
@MainActor
...
public enum AgentConversationError: LocalizedError, Equatable {
    ...
    public var errorDescription: String? {
        switch self {
        case .missingCommand: "Set the ACP Agent executable in Settings › AI before starting a conversation."
        case .missingProvider: "Choose an AI provider that uses the Responses API in Settings › AI."
        case .missingAPIKey: "Add an API key to the selected AI provider in Settings › AI."
