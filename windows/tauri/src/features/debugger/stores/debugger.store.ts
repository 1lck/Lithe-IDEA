...
const BREAKPOINTS_STORAGE_KEY = "lithe-debugger-breakpoints";
const USER_CONFIGS_STORAGE_KEY = "lithe-debugger-user-configs";
const WATCH_EXPRESSIONS_STORAGE_KEY = "lithe-debugger-watch-expressions";
