...
import { getRequiredLitheDefaultColor } from "@/extensions/themes/default-theme";
...
function litheTerminalColor(name: string): string {
  return getRequiredLitheDefaultColor("dark", name);
}

const DEFAULT_THEME: TerminalTheme = {
  background: litheTerminalColor("background"),
  foreground: litheTerminalColor("foreground"),
  cursor: litheTerminalColor("primary"),
  cursorAccent: litheTerminalColor("background"),
  selectionBackground: litheTerminalColor("selection"),
  selectionForeground: litheTerminalColor("foreground"),
  black: litheTerminalColor("terminal-black"),
  red: litheTerminalColor("terminal-red"),
  green: litheTerminalColor("terminal-green"),
  yellow: litheTerminalColor("terminal-yellow"),
  blue: litheTerminalColor("terminal-blue"),
  magenta: litheTerminalColor("terminal-magenta"),
  cyan: litheTerminalColor("terminal-cyan"),
  white: litheTerminalColor("terminal-white"),
  brightBlack: litheTerminalColor("terminal-bright-black"),
  brightRed: litheTerminalColor("terminal-bright-red"),
  brightGreen: litheTerminalColor("terminal-bright-green"),
  brightYellow: litheTerminalColor("terminal-bright-yellow"),
  brightBlue: litheTerminalColor("terminal-bright-blue"),
  brightMagenta: litheTerminalColor("terminal-bright-magenta"),
  brightCyan: litheTerminalColor("terminal-bright-cyan"),
  brightWhite: litheTerminalColor("terminal-bright-white"),
};
