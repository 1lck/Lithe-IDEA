...
export const settingsSearchIndex: SettingSearchRecord[] = [
  ...
  },
  {
    ...
    keywords: ["sticky", "scroll", "scope", "function", "class", "header"],
  },
  {
    id: "editor-bracket-pair-colorization",
    tab: "editor",
    section: "Editor",
    label: "Bracket Pair Colorization",
    description: "Use matching colors to distinguish nested bracket pairs",
    keywords: ["bracket", "pair", "color", "parentheses", "nested", "rainbow"],
  },
  {
    ...
    keywords: ["smooth", "scroll", "animation", "editor"],
  },
  {
    id: "editor-scroll-beyond-last-line",
    tab: "editor",
    section: "Editor",
    label: "Scroll Beyond Last Line",
    description: "Allow scrolling the final line above the bottom of the editor",
    keywords: ["scroll", "last", "line", "bottom", "padding"],
  },
  {
    ...
    keywords: ["cursor", "caret", "style", "line", "block", "underline"],
  },
  {
    ...
    keywords: ["cursor", "caret", "blink", "animation", "solid"],
  },
  {
  ...
  // File Tree Settings
  {
    ...
    keywords: ["sort", "order", "folders", "files", "name", "alphabetical"],
  },
  {
  ...
  },
  {
    ...
    keywords: ["indent", "guide", "tree", "nested", "folder", "line"],
  },
  {
  ...
  {
    id: "file-tree-show-git-status",
    tab: "file-explorer",
    section: "Display",
    label: "Show Git Status",
    description: "Display Git color decorations beside changed files",
    keywords: ["git", "file tree", "files", "decorations", "status", "color"],
  },
  {
    id: "file-tree-auto-reveal-active-file",
    tab: "file-explorer",
    section: "Behavior",
    label: "Auto Reveal Active File",
    description: "Expand and scroll Files to the active editor file",
    keywords: ["auto", "reveal", "active", "file", "scroll", "expand", "editor"],
  },
  {
    id: "file-tree-confirm-before-delete",
    tab: "file-explorer",
    section: "Behavior",
    label: "Confirm Before Delete",
    description: "Ask for confirmation before deleting a file or folder",
    keywords: ["confirm", "delete", "file", "folder", "safety", "warning"],
  },
  {
  ...
  },
  {
    ...
    section: "Theme",
    label: "Custom Themes",
    description: "Create, import, and remove custom Lithe theme JSON files",
  ...
  },
  {
    ...
    keywords: ["tab", "close", "button", "active", "hover", "always"],
  },
  {
    id: "appearance-expanded-activity-bar",
    tab: "appearance",
    section: "Layout",
  ...
  // AI Settings
  {
    ...
    description: "Choose the provider and model used by Lithe Agent",
  ...
  {
    id: "terminal-cursor-inactive-style",
    tab: "terminal",
    section: "Cursor",
