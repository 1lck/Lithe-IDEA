const STORAGE_KEY = "lithe-update-preferences";

const DEFAULT_REMIND_LATER_MS = 24 * 60 * 60 * 1000;

export const UPDATE_DISMISSED_EVENT = "lithe:update-dismissed";
export const UPDATE_PREFERENCES_CHANGED_EVENT = "lithe:update-preferences-changed";
