...
import {
  getLitheDefaultCssVariables,
  getLitheDefaultSyntaxTokens,
  getLitheDefaultTheme,
...
export const APPEARANCE_BOOTSTRAP_CACHE_KEY = "lithe.bootstrap.appearance.v1";
...
export const LITHE_BOOTSTRAP_DEFAULTS = {
  dark: {
    id: getLitheDefaultTheme("dark").id,
    type: getLitheDefaultTheme("dark").type,
    colors: getLitheDefaultTheme("dark").colors,
    syntax: getLitheDefaultTheme("dark").syntax,
  },
  light: {
    id: getLitheDefaultTheme("light").id,
    type: getLitheDefaultTheme("light").type,
    colors: getLitheDefaultTheme("light").colors,
    syntax: getLitheDefaultTheme("light").syntax,
  },
};

export const DEFAULT_APPEARANCE_BOOTSTRAP_CACHE: AppearanceBootstrapCache = {
  version: 1,
  themeId: LITHE_BOOTSTRAP_DEFAULTS.dark.id,
  themeType: LITHE_BOOTSTRAP_DEFAULTS.dark.type,
  cssVariables: getLitheDefaultCssVariables("dark"),
  syntaxTokens: getLitheDefaultSyntaxTokens("dark"),
