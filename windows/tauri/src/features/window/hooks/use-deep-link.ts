 ...
 * Supports:
 *   lithe://open?path=...&line=...&type=directory
 *   lithe://extension/install/{extensionId}
 *   lithe://settings?tab=advanced
 */
...
const SUPPORTED_DEEP_LINK_PROTOCOLS = new Set(["lithe:", "lithe-dev:", "lithe-preview:"]);
