...
export function EmptyEditorState() {
  ...
  return (
    <div className="flex size-full min-h-0 items-center justify-center bg-background px-6 py-8">
      <div className="flex max-w-md flex-col items-center gap-3 text-center">
        ...
        <p className="ui-text-sm text-subtle-foreground">{t("workbench.emptyEditorDescription")}</p>
      </div>
    </div>
  );
}
