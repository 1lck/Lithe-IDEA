...
import type { RecentFile, RecentFilesState, RecentFilesStore } from "../types/recent-files.types";

const MAX_RECENT_FILES = 50;
const PRUNE_THRESHOLD_SCORE = 5; // Remove files with frecency score below this

const useRecentFilesStoreBase = create<RecentFilesStore>()(
  immer(
    persist(
      (set, get) => ({
        recentFiles: [],
...
export const useRecentFilesStore = createSelectors(useRecentFilesStoreBase);
