...
const AIChatInputBar = memo(function AIChatInputBar({
  ...
  const handleLitheProviderChange = useCallback(
  ...
  const handleLitheModelChange = useCallback(
    (nextModelId: string) => {
        ...
        <ChatComposerToolbar className={cn(isInitialPresentation && "items-center px-3 pb-3 pt-0")}>
          ...
          <div className="flex shrink-0 items-center gap-1">
            ...
            <ChatPreferencesMenu
              ...
              onProviderChange={handleLitheProviderChange}
              onModelChange={handleLitheModelChange}
