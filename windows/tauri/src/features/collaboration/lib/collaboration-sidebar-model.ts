...
const THREADS_START_MARKER = "<!-- lithe:threads -->";
const THREADS_END_MARKER = "<!-- /lithe:threads -->";
const NOTES_START_MARKER = "<!-- lithe:notes -->";
const NOTES_END_MARKER = "<!-- /lithe:notes -->";
const NOTES_WORKSPACE_START_MARKER = "<!-- lithe:notes-workspace";
const NOTES_WORKSPACE_END_MARKER = "/lithe:notes-workspace -->";
const COLLABORATION_NOTE_BUFFER_PREFIX = "lithe-collaboration://channel/";
