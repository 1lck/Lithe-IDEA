...
export const useGitConsoleStore = create<{ historyTruncated: boolean; records: GitConsoleRecord[]; active: Map<string, string>; authentication: GitExecutionEvent[] }>(() => ({ historyTruncated: false, records: [], active: new Map(), authentication: [] }));
