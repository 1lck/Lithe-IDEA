...
export function GitHubNotificationsMenu() {
  ...
  useEffect(() => {
    ...
    void checkAuth();
  }, [checkAuth, isGitHubAvailable]);

  useEffect(() => {
    if (!isGitHubAvailable || !isAuthenticated) return;
  ...
  }, [fetchNotifications, isAuthenticated, isGitHubAvailable]);

  useEffect(() => {
    if (isGitHubAvailable && isOpen && isAuthenticated) void fetchNotifications();
  }, [fetchNotifications, isAuthenticated, isGitHubAvailable, isOpen]);
