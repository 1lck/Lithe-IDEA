...
const GitHubPRsView = memo(() => {
  ...
  useEffect(() => {
    ...
    window.addEventListener("lithe:github-palette-action", handlePaletteAction);
    return () => window.removeEventListener("lithe:github-palette-action", handlePaletteAction);
  }, [handleRefreshActiveSection]);
