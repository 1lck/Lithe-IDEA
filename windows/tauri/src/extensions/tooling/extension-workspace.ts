...
export const LITHE_ROOT = resolve(EXTENSION_DOMAIN_ROOT, "../..");
export const EXTENSIONS_ROOT = join(LITHE_ROOT, "extensions");
...
const RESERVED_BUILT_IN_THEME_IDS = new Set(["lithe-light", "lithe-dark"]);
const RESERVED_BUILT_IN_THEME_NAMES = new Set(["lithe light", "lithe dark"]);
