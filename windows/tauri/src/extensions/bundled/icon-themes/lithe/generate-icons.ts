...
fileIcons.push(
  ...
  { id: "lithe", label: "Lithe", color: "#4E91D9", accent: "#D7E8FF", kind: "bolt", text: "L" },
  {
    id: "codex",
    label: "Codex",
    color: "#657083",
...
const themeVariants: ThemeVariant[] = [
  {
    id: "lithe-icons",
    name: "Dark assets",
    description: "Calm outline and duotone file and folder icons for dark Lithe themes.",
    directory: "",
    background: "#11151B",
    transform: (icon) => icon,
  },
  {
    id: "lithe-icons-light-assets",
    name: "Light assets",
    description: "A higher-contrast Lithe icon palette tuned for light themes.",
    directory: "light",
    background: "#F6F8FB",
    transform: (icon) => ({
...
function themeContribution() {
  const darkVariant =
    themeVariants.find((variant) => variant.id === "lithe-icons") ?? themeVariants[0];
  const lightVariant =
    themeVariants.find((variant) => variant.id === "lithe-icons-light-assets") ?? darkVariant;

  return {
    id: "lithe-icons",
    name: "Lithe Icons",
    description: "Calm outline and duotone icons designed for the Lithe interface.",
...
function manifest() {
  return {
    ...
    activationEvents: ["onIconTheme:lithe-icons"],
    license: "MIT",
    bundled: true,
...
<head>
  ...
  <title>Lithe Icons Preview</title>
  <style>
    :root {
      color-scheme: dark;
      --bg: #11151b;
...
<body>
  <main>
    <header>
      <div>
        <h1>Lithe Icons</h1>
        <p>Calm outline and duotone icons designed for every Lithe file surface. This page is static and can be opened directly from disk.</p>
      </div>
  ...
  <script>
    ...
    function updateVariant() {
      ...
      const basePath = variantPaths[variantId] || variantPaths["lithe-icons"];
      const palette = variantPalettes[variantId] || variantPalettes["lithe-icons"];
