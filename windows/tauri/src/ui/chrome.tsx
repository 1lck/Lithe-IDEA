...
export const chromeBarVariants = cva(
  "font-sans ui-text-chrome flex shrink-0 items-center text-subtle-foreground",
  {
    variants: {
      region: {
        title:
          "h-(--lithe-title-bar-height) gap-(--lithe-chrome-gap) bg-transparent px-(--lithe-chrome-padding-inline)",
        footer:
          "h-(--lithe-footer-height) gap-(--lithe-chrome-gap) bg-transparent px-(--lithe-chrome-padding-inline)",
        tabs: "h-(--lithe-tab-bar-height) min-h-(--lithe-tab-bar-height) gap-(--lithe-chrome-gap) bg-tab-bar px-(--lithe-chrome-padding-inline)",
        sidebar:
          "min-h-(--lithe-sidebar-header-height) gap-(--lithe-chrome-gap) bg-background/92 px-(--lithe-chrome-padding-inline)",
      },
      emphasis: {
...
export const chromeGroupVariants = cva("flex min-w-0 items-center", {
  variants: {
    gap: {
      none: "gap-0",
      tight: "gap-(--lithe-chrome-gap-tight)",
      default: "gap-(--lithe-chrome-gap)",
      loose: "gap-(--lithe-chrome-gap-loose)",
    },
    grow: {
      true: "flex-1",
      false: "shrink-0",
...
export const chromeLabelVariants = cva("min-w-0 truncate leading-(--lithe-chrome-line-height)", {
  variants: {
    tone: {
