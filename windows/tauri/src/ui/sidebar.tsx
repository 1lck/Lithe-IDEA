...
export function SidebarTitleBar({
  ...
  return (
    <div
      className={cn(
        "font-sans flex h-(--lithe-pane-header-height) min-w-0 shrink-0 select-none items-center gap-2 overflow-hidden px-3",
        className,
      )}
      {...props}
    >
...
export function SidebarListEditor({
  ...
  return (
    <div
      className={cn(
        "font-sans ui-text-chrome flex min-h-(--lithe-tab-height) w-full min-w-0 items-center gap-(--lithe-chrome-gap-loose) rounded-(--lithe-chrome-radius) bg-accent/80 px-2 py-1 text-foreground",
        className,
      )}
      {...props}
    >
...
export function SidebarSectionHeader({
  ...
  return (
    <button
      type="button"
      className={cn(
        "font-sans ui-text-chrome flex h-(--lithe-tab-height) w-full select-none items-center gap-1 rounded-(--lithe-chrome-radius) px-2 text-left font-medium text-subtle-foreground transition-colors hover:bg-accent/50 hover:text-foreground focus-visible:bg-accent/60 focus-visible:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/20",
        variant === "surface" &&
...
export function SidebarSectionLabel({
  ...
  return (
    <div
      className={cn(
        "font-sans ui-text-chrome flex h-(--lithe-chrome-control-height) min-w-0 select-none items-center gap-(--lithe-chrome-gap-loose) px-2 text-subtle-foreground",
        className,
      )}
      {...props}
    >
...
export function SidebarTabBar<TValue extends string>({
  ...
  return (
    ...
    >
      <div
        className={cn(
          "flex h-(--lithe-pane-header-height) shrink-0 items-center overflow-hidden px-3",
          className,
        )}
      >
