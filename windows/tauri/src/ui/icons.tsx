...
const legacyIconCompatibility: Record<string, ComponentType<any>> = {
  ...
  AppStack: lucideIcons.Blocks,
  ArrowBoldDownToLine: lucideIcons.ArrowDownToLine,
  ArrowCornerBottomLeft: lucideIcons.CornerDownLeft,
  ...
  ArrowsRotateCenter: lucideIcons.RefreshCw,
  ArrowsToLineY: lucideIcons.FoldVertical,
  BoltLightning: lucideIcons.Zap,
  BoltLightningSlash: lucideIcons.ZapOff,
  BracketsCurly: lucideIcons.Braces,
  BranchMerge: lucideIcons.GitMerge,
  Broom: lucideIcons.Brush,
  ChartActivity: lucideIcons.Activity,
  ChatBubble: lucideIcons.MessageCircle,
  ChatBubbleContent: lucideIcons.MessageCircleMore,
  CheckList: lucideIcons.ListChecks,
  ChevronExpandY: lucideIcons.ChevronsUpDown,
  CircleDots: lucideIcons.CircleDot,
  CircleDotted: lucideIcons.CircleDashed,
  CircleHalfDashedPause: lucideIcons.Pause,
  CircleHalfDashedStop: lucideIcons.Square,
  CircleHashtag: lucideIcons.Hash,
  CircleInfo: lucideIcons.Info,
  CircleQuestion: lucideIcons.CircleHelp,
  CircleWarning: lucideIcons.CircleAlert,
  CircleXmark: lucideIcons.CircleX,
  Circles: lucideIcons.Orbit,
  ClipboardContent: lucideIcons.ClipboardList,
  ClockRotateAnticlockwise: lucideIcons.History,
  CloudBolt: lucideIcons.CloudLightning,
  CloudSlash: lucideIcons.CloudOff,
  CodeBranch: lucideIcons.GitBranch,
  Cube: lucideIcons.Box,
  Dots: lucideIcons.Ellipsis,
  DoubleChevronLeft: lucideIcons.ChevronsLeft,
  DoubleChevronRight: lucideIcons.ChevronsRight,
  DoubleChevronUp: lucideIcons.ChevronsUp,
  EyeSlash: lucideIcons.EyeOff,
  FileContent: lucideIcons.FileText,
  FileSettings: lucideIcons.FileCode,
  Files2: lucideIcons.Files,
  FloppyDisk: lucideIcons.Save,
  FolderStar: lucideIcons.FolderHeart,
  Gear: lucideIcons.Settings,
  Gear2: lucideIcons.Settings2,
  Language: lucideIcons.Languages,
  LockKey: lucideIcons.LockKeyhole,
  MagicWand: lucideIcons.WandSparkles,
  Magnifier: lucideIcons.Search,
  MagnifierMinus: lucideIcons.ZoomOut,
  MagnifierPlus: lucideIcons.ZoomIn,
  MathFunction: lucideIcons.SquareFunction,
  MediaPlay: lucideIcons.Play,
  Microphone: lucideIcons.Mic,
  MoneyBillCoin: lucideIcons.Banknote,
  Nodes: lucideIcons.Workflow,
  OpenExternal: lucideIcons.ExternalLink,
  OpenInNewWindow: lucideIcons.Maximize2,
  PaperPlane2: lucideIcons.Send,
  Pen3: lucideIcons.Pen,
  PenWriting4: lucideIcons.PencilLine,
  PinSlash: lucideIcons.PinOff,
  PinTack: lucideIcons.Pin,
  PuzzlePiece: lucideIcons.Puzzle,
  Refresh2: lucideIcons.RefreshCw,
  Robot: lucideIcons.Bot,
  ShapeSquare: lucideIcons.Square,
  SidebarLeftShow: lucideIcons.PanelLeft,
  Sitemap: lucideIcons.Workflow,
  Sliders: lucideIcons.SlidersHorizontal,
  SquareGrid2: lucideIcons.LayoutGrid,
  Stack: lucideIcons.Layers,
  TableCols: lucideIcons.Columns3,
  TableRowNewTop: lucideIcons.PanelsTopLeft,
  TableRows: lucideIcons.Rows3,
  TextA: lucideIcons.CaseSensitive,
  TextAlignCenter: lucideIcons.AlignCenter,
  TextAlignJustify: lucideIcons.AlignJustify,
  TextAlignLeft: lucideIcons.AlignLeft,
  TouchClick: lucideIcons.MousePointerClick,
  TriangleWarning: lucideIcons.TriangleAlert,
  UnorderedList: lucideIcons.List,
  Xmark: lucideIcons.X,
};

const Nucleo: Record<string, ComponentType<any>> = new Proxy(lucideIcons, {
  get(icons, property) {
    const nucleoName = String(property);
    const lucideName = nucleoName.replace(/^Icon/, "").replace(/Outline18$/, "");
    return (
      icons[lucideName as keyof typeof icons] ??
      legacyIconCompatibility[lucideName] ??
      CircleHelp
    );
  },
});
