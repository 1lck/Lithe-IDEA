...
const tabsListVariants = cva(
  "group/tabs-list inline-flex w-fit items-center justify-center text-subtle-foreground group-data-[orientation=vertical]/tabs:h-fit group-data-[orientation=vertical]/tabs:flex-col",
  {
    variants: {
      variant: {
        default:
          "gap-(--lithe-chrome-gap-tight) rounded-(--lithe-chrome-radius) bg-surface/55 p-0.5",
        segmented:
          "min-h-(--lithe-chrome-control-height) items-stretch overflow-hidden rounded-(--lithe-chrome-radius) bg-surface/55",
        line: "gap-(--lithe-chrome-gap) bg-transparent",
        bare: "gap-(--lithe-chrome-gap) bg-transparent",
      },
    },
    defaultVariants: {
      variant: "default",
