...
impl CoreCommand {
    pub fn parse(value: &str) -> Option<Self> {
        match value {
            ...
            "shelf.create" => Some(Self::ShelfCreate),
            "shelf.list" => Some(Self::ShelfList),
            "shelf.restore" => Some(Self::ShelfRestore),
            "shelf.delete" => Some(Self::ShelfDelete),
            ...
            "git.shelfPatches" => Some(Self::GitShelfPatches),
            "git.shelfClean" => Some(Self::GitShelfClean),
