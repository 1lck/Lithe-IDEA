...
/// `.factorypath` is Eclipse m2e-apt metadata generated by JDTLS; hiding it
/// keeps the project tree uncluttered without moving or deleting the file.
const BUILT_IN_HIDDEN_FILE_PATTERNS: &[&str] = &[".DS_Store", ".factorypath"];
