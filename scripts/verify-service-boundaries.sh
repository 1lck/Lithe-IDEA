...
ui_service_pattern='\b(MavenService|JavaRunService|JavaDebugService|ProjectRuntimeService|JavaImplementationMarkerService|GitService|WorkspaceSearchIndex)\b'
