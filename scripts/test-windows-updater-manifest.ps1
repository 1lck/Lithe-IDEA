...
$version = "9.8.7"
$bundle = Join-Path $testOutput "Lithe-$version-windows-x64.nsis.zip"
...
try {
    ...
    $expectedURL = "https://github.com/example/Lithe-IDEA/releases/download/v$version/Lithe-$version-windows-x64.nsis.zip"
