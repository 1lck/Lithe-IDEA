...
| Agent conversation (ACP) | ACP v1 session, streamed updates, permission decisions, cancellation, and process lifecycle in the shared Rust host | executable configuration, workspace selection, module enablement, and conversation UI |
