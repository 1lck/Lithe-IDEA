...
final class AppModel: ObservableObject {
    ...
    var rootNode: FileNode? {
        workspaceFeature.rootNode
    }

    var projectFiles: [URL] {
        workspaceFeature.projectFiles
    }
    ...
    var isLoadingWorkspace: Bool {
        workspaceFeature.isLoadingWorkspace
    }

    var isRefreshingWorkspace: Bool {
        workspaceFeature.isRefreshingWorkspace
    }

    var searchResults: [FileSearchResult] {
        searchFeature.searchResults
    }

    var isSearching: Bool {
        searchFeature.isSearching
    }

    var searchEverywhereResults: SearchEverywhereResults {
        searchFeature.searchEverywhereResults
    }

    var isSearchingEverywhere: Bool {
        searchFeature.isSearchingEverywhere
    }

    var projectReplacementFiles: [ProjectReplacementFile] {
        searchFeature.projectReplacementFiles
    }

    var isLoadingProjectReplacement: Bool {
        searchFeature.isLoadingProjectReplacement
    }
    ...
    var localHistoryEntries: [LocalHistoryEntry] {
        projectHistoryFeature.localHistoryEntries
    }
    ...
    var localHistoryDiffRows: [DiffRow] {
        projectHistoryFeature.localHistoryDiffRows
    }

    var isLoadingLocalHistory: Bool {
        projectHistoryFeature.isLoadingLocalHistory
    }
    ...
    var projectLocalHistoryDiffRows: [DiffRow] {
        projectHistoryFeature.projectLocalHistoryDiffRows
    }
