...
actor LocalHistoryService {
    ...
    private var visibilityRules: LocalHistoryVisibilityRules
    ...
    func updateVisibilityRules(_ rules: LocalHistoryVisibilityRules) {
    ...
    private func makeEntry(_ value: LocalHistoryEntryPayload) -> LocalHistoryEntry? {
