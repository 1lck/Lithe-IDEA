...
| `extension-host/` | Node process running unmodified VS Code extensions on Theia's plugin side; talks to Lithe only through `shared/contracts/vscode-extension-host.md` (#737 prototype, not yet packaged) |
